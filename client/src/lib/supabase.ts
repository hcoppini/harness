...
export const DEFAULT_SUPABASE_URL = (process.env as any).EXPO_PUBLIC_SUPABASE_URL || '';
export const DEFAULT_SUPABASE_ANON_KEY = (process.env as any).EXPO_PUBLIC_SUPABASE_ANON_KEY || '';
