...
def get_dashboard_summary(conn: Optional[sqlite3.Connection] = None) -> Dict[str, Any]:
    ...
    summary = {
        ...
        "metrics": {
            ...
            "bavarian_gpa": tum_overview.get("bavarian_assessment", {}).get("german_gpa", 1.38),
            "tum_score": tum_overview.get("bavarian_assessment", {}).get("total_tum_points", 90.0),
            "tum_verdict": tum_overview.get("bavarian_assessment", {}).get("verdict", "DIRECT ADMISSION SAFE (Level 1)"),
            "target_gpa": 5.0,
